...
function NavbarOptions(): React.FunctionComponentElement<HTMLAllCollection> {
    ...
    return (
        <Fragment>
            <LiLink>
                <ALinks onClick={() => ipSearch()}>IP-SEARCH</ALinks>
            </LiLink>
            <LiLink>
                <ALinks onClick={() => speedConnection()}>
                    SPEED-CONNECTION
                </ALinks>
            </LiLink>
            {userData.user ? (
                <LiLink>
                    <AVioletLinks onClick={() => logout()}>LOGOUT</AVioletLinks>
                </LiLink>
            ) : (
                <>
                    <LiLink>
                        <AVioletLinks onClick={() => register()}>
                            REGISTER
                        </AVioletLinks>
                    </LiLink>
                    <LiLink>
                        <ALinks onClick={() => login()}>LOGIN</ALinks>
                    </LiLink>
                </>
            )}
        </Fragment>
